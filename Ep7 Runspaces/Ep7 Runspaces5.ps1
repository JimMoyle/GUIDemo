...
#region Episode 2 code
	...
	#$path = 'E:\JimM\Dropbox\Dropbox (Personal)\ScriptScratch\YouTube\Ep8 Runspaces Pt2\Ep8 Runspaces Pt2'
...
$script:syncHash.titleButton.add_Click({
    ...
    $syncHash.sleepSecs = $syncHash.titleTextBox.text
    ...
    [void]$PowerShell.AddScript({
        ...
        Start-Sleep -Seconds $syncHash.sleepSecs
        #$syncHash.titleTextBlock.Text = "$($syncHash.sleepSecs) second sleep finished"
		#Wait-Debugger
		#Measure-Command -Expression {
			$syncHash.titleTextBlock.Dispatcher.Invoke([action]{
				$syncHash.titleTextBlock.Text = "$($syncHash.sleepSecs) second sleep finished"
			})
		#}
    })
